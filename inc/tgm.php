...
function philosophy_register_required_plugins() {
	...
	$plugins = array(
		...
		array(
			'name'               => 'Philosophy Companion', // The plugin name.
			'slug'               => 'philosophy_companion', // The plugin slug (typically the folder name).
			'source'             => get_template_directory() . '/plugins/philosophy_companion.zip', // The plugin source.
